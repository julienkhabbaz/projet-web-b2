 ...
 */
final class Version20200516174454 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE restaurant CHANGE filename filename VARCHAR(255) DEFAULT NULL');
