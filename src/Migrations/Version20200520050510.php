 ...
 */
final class Version20200520050510 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE commande CHANGE client_id client_id INT DEFAULT NULL, CHANGE plat_id plat_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE user ADD phone VARCHAR(255) DEFAULT NULL, ADD site_web VARCHAR(255) DEFAULT NULL, CHANGE roles roles JSON NOT NULL, CHANGE nom nom VARCHAR(255) DEFAULT NULL, CHANGE prenom prenom VARCHAR(255) DEFAULT NULL, CHANGE solde solde INT DEFAULT NULL');
        $this->addSql('ALTER TABLE plat CHANGE restaurant_id restaurant_id INT DEFAULT NULL, CHANGE description description VARCHAR(255) DEFAULT NULL, CHANGE filename filename VARCHAR(255) DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
    }
