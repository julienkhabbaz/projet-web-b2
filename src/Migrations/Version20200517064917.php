 ...
 */
final class Version20200517064917 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE commande ADD quantite INT NOT NULL, CHANGE client_id client_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE commande DROP quantite, CHANGE client_id client_id INT DEFAULT NULL');
