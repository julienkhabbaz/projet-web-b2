 ...
 */
final class Version20200519131211 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE plat ADD filename VARCHAR(255) DEFAULT NULL, ADD updated_at DATETIME DEFAULT NULL, CHANGE restaurant_id restaurant_id INT DEFAULT NULL, CHANGE description description VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE commande CHANGE client_id client_id INT DEFAULT NULL, CHANGE plat_id plat_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE plat DROP filename, DROP updated_at, CHANGE restaurant_id restaurant_id INT DEFAULT NULL, CHANGE description description VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
