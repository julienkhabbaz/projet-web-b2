 ...
 */
final class Version20200519034622 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE commande CHANGE client_id client_id INT DEFAULT NULL, CHANGE plat_id plat_id INT DEFAULT NULL, CHANGE heure_livraisob heure_livraison TIME NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE commande CHANGE client_id client_id INT DEFAULT NULL, CHANGE plat_id plat_id INT DEFAULT NULL, CHANGE heure_livraison heure_livraisob TIME NOT NULL');
