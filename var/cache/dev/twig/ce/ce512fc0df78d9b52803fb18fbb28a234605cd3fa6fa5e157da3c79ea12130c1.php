...
class __TwigTemplate_d914932a945237377b13f66c805e5d08715f0dd6a4064920356d29a827efb66b extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t      ";
    ...
    <table class=\"table table-bordered datatable\" id=\"table-1\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["restaurant"]) {
            ...
            echo "\" class=\"btn btn-primary btn-sm btn-icon icon-left\"> <i class=\"entypo-delete\"></i>Supprimer</a>
...
\t\t\t\t<td><img src=\"{{ '/images/restaurants/empty.png' | imagine_filter('medium') | imagine_filter('thumb')}}\" alt=\"Logo\" style=\"width: 50px; height:60px;\"></td>
                ...
                <td class=\"col-md-3\" style=\"vertical-align: middle; text-align: center;\">
                    ...
                    <a href=\"{{ path('restaurant_delete', {'id': restaurant.id}) }}\" class=\"btn btn-primary btn-sm btn-icon icon-left\"> <i class=\"entypo-delete\"></i>Supprimer</a>
